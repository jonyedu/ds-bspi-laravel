        ...
        <div class="col-lg-12 col-md-12 col-sm-12 p-5">
          <form>
            <div class="row">
              ...
              <div class="col-lg-4 col-md-4 col-sm-12" v-if="activoField">
                <div class="form-group">
...
export default {
  ...
  methods: {
    ...
    guardarActualizar: function() {
      ...
      let url = "";
      let mensaje = "";
      if (that.$props.datoMod !== null) {
        url = that.$props.urlModificar;
        mensaje = "Datos actualizados correctamente.";
      } else {
        url = that.$props.urlGuardar;
